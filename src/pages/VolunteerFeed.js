...
const VolunteerFeed = () => {
  ...
  useEffect(() => {
    if (!mapContainerRef.current || !userLocation || !GOOGLE_MAPS_API_KEY) return;
    ...
    <div className="volunteer-feed-page">
      <header className="top-nav">
        <div className="nav-left">
          ...
          <button className="pill-btn">English</button>
        </div>
        <div className="nav-center">
          <input
            className="search-input"
            placeholder="Search area or request"
            value={searchQuery}
        ...
        <div className="nav-right">
          ...
          <button className="primary-btn" onClick={() => navigate('/request/new')}>
            Add Request
          </button>
        </div>
      </header>
                    ...
                    <div className="request-card-header">
                      <div>
                        ...
                        {request.location?.city ? (
                          <p className="muted-text">{request.location.city}</p>
                        ) : (
                          request.location?.address && (
                            <p className="muted-text">{request.location.address}</p>
                          )
                        )}
                      </div>
